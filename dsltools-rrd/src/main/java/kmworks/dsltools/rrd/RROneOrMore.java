 ...
 * @since 1.0
 */
public final class RROneOrMore extends SingletonNode {

    protected RROneOrMore() {
        super();
        bMargin = 16;
    }
    ...
    public void accept(SVGRenderingVisitor v, RenderingParams params) {
        v.renderOneOrMore(this, params);
    }

    @Override
    public int getWidth() {
        return 2 * (hPad + RAD) + getChild().getWidth();
    }

    @Override
    public int getHeight() {
        return getChild().getHeight() + bMargin + bPad;
    }
