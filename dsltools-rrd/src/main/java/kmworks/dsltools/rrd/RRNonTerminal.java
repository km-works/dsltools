 ...
 * @since 1.0
 */
public final class RRNonTerminal extends LiteralNode {

  protected RRNonTerminal(String label) throws URISyntaxException {
    super(label, new URI("#" + label));
  }

  protected RRNonTerminal(String label, URI uri) {
    super(label, uri);
  }

  @Override
  public void accept(SVGRenderingVisitor v, RenderingParams params) {
    v.renderNonTerminal(this, params);
  }
