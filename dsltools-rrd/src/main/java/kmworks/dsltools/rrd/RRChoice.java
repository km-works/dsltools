 ...
 * @since 1.0
 */
public final class RRChoice extends ContainerNode {
  ...
  public int getWidth() {
    ...
    hPad = size > 1 ? HPAD : 0;
    if (size > 1) {
      return 2*horMargin() + maxWidth();
    } else {
      return getFirstChild().getWidth();
    }
  }
  ...
  public int getHeight() {
    ...
    if (size > 1) {
      ...
      return getFirstChild().getHeight();
    }
  }
