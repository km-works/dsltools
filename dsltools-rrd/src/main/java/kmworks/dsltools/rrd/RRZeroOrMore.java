 ...
 * @since 1.0
 */
public final class RRZeroOrMore extends SingletonNode {

    protected RRZeroOrMore() {
        super();
        bMargin = 8;
    }
    ...
    public void accept(SVGRenderingVisitor v, RenderingParams params) {
        v.renderZeroOrMore(this, params);
    }

    @Override
    public int getWidth() {
        return 2 * horMargin() + getChild().getWidth();
    }

    @Override
    public int getHeight() {
        return TOP + tMargin + getChild().getHeight() + bMargin + bPad;
    }
