...
public interface Constants {
    ...
    /**
     * The start index for lines. Note that the same constant is also defined as {@link xtc.parser.ParserBase#FIRST_LINE} to
     * avoid parsers depending on this class.
     */
    public static final int FIRST_LINE = 1;

    /**
     * The start index for columns. Note that the same constant is also defined as {@link xtc.parser.ParserBase#FIRST_COLUMN} to
     * avoid parsers depending on this class.
     */
    ...
    // =========================================================================
    /**
     * The property name for unmodified nodes. The value must be the unmodified {@link xtc.tree.Node node} before any
     * transformations.
     */
    public static final String ORIGINAL = "xtc.Constants.Original";

    /**
     * The property name for synthetic nodes. The value must be a <code>Boolean</code>.
     */
    ...
    /**
     * The property name for types. The value must be a xtc.type.Type type.
     */
    ...
    /**
     * The attribute name of all parent attributes.
     */
    public static final String NAME_PARENT = "parent";  ///+ <CR005/>
