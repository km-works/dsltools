 ...
 */
@Value.Immutable
public abstract class CharClass extends Terminal {
    @Value.Parameter public abstract String value();
    @Value.Parameter public abstract String caption();
    @Value.Parameter public abstract Seq<CharRange> ranges();
}
